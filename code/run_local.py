...
tf.app.flags.DEFINE_string("model_dir", "./model_uniform_4order/", "model check point dir")
...
tf.flags.DEFINE_string("log_dir1", "nohup.out_reload", "log dir")
...
def main(_):
    ...
    if FLAGS.task_type == 'train':
        ...
        eval_hooks = []
        eval_hooks.append(ckpt_utils.CkptDeletionHook(FLAGS.log_dir1, FLAGS.best_metric_to_export, FLAGS.model_dir, "evaluate" ))
